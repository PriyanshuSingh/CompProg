...
struct mov{int lr,r,ind;};
bool cmp(mov a,mov b){return (a.lr == b.lr)?((a.r == b.r)?a.ind<b.ind:a.r>b.r):a.lr>b.lr;}
int main(){
    mov arr[110];
    int l[110],r[110],t,n;
    ios_base::sync_with_stdio(false);
    cin>>t;while(t--){
        cin>>n;forall(i,0,n)cin>>l[i];forall(i, 0, n)cin>>r[i];
        forall(i, 0, n)arr[i] = {l[i]*r[i],r[i],i+1};
        sort(arr, arr+n, cmp);
